    ...
    it('should put a new student into the db on a POST request', (done) => {
      chai.request(server)
        ...
        .then((res) => {
          ...
          res.body.data[0].firstName.should.equal('Draco');
          done();
        });
    });
  });
        ...
        .then((students) => {
          ...
          chai.request(server)
            ...
            .then((res) => {
              ...
              res.body.data.firstName.should.equal('Harry');
              res.body.data.lastName.should.equal('Potter');
              res.body.data.year.should.equal(2);
              done();
            });
        });
    });
